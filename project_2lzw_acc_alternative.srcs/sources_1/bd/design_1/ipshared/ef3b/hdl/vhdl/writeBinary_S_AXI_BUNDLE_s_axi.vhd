...
entity writeBinary_S_AXI_BUNDLE_s_axi is
generic (
...
end entity writeBinary_S_AXI_BUNDLE_s_axi;
...
architecture behave of writeBinary_S_AXI_BUNDLE_s_axi is
    ...
    constant ADDR_CODE_DATA_0  : INTEGER := 16#18#;
    constant ADDR_CODE_CTRL    : INTEGER := 16#1c#;
...
-- ----------------------- Register logic ----------------
    ...
    code                 <= STD_LOGIC_VECTOR(int_code);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CODE_DATA_0) then
                    int_code(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_code(31 downto 0));
                end if;
            end if;
        end if;
    end process;
