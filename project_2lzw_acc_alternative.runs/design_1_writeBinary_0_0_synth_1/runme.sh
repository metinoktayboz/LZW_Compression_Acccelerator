...
HD_PWD='C:/EEM464/labs/project_2lzw_acc_alternative/project_2lzw_acc_alternative.runs/design_1_writeBinary_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_writeBinary_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_writeBinary_0_0.tcl
